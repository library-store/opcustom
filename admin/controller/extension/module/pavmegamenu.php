...
class ControllerExtensionModulePavmegamenu extends Controller
{
    ...
    public function __construct($registry)
    {
        ...
        $this->types = array(
            ...
            'category-post' => $this->language->get('text_category_post'),
        ...
        if ($menu['item']) {
            switch ($menu['type']) {
                ...
                case 'manufacturer':
                    ...
                    break;
                case 'category-post':
                    $category = $this->model_post_category->getCategory($menu['item']);
                    $menu['megamenu-category-post'] = isset($category['name']) ? $category['name'] : "";
                    break;
                case 'post':
                    $product = $this->model_post_post->getPost($menu['item']);
                    $menu['megamenu-post'] = isset($product['name']) ? $product['name'] : "";
                    break;
            }
        }
